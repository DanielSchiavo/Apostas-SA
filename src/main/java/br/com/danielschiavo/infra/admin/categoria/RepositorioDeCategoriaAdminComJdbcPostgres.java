...
import br.com.danielschiavo.dominio.categoria.Categoria.CategoriaBuilder;
import br.com.danielschiavo.dominio.categoria.RemoverCategoriaException;
			...
			try (ResultSet rs = ps.executeQuery()) {
	            if (rs.next()) {
	                ...
	                CategoriaBuilder categoriaBuilder = 
	                			Categoria.builder().id(UUID.fromString(id))
	                							 .nome(nome)
	                							 .icone(icone)
	                ...
	                if (numeroApostas != null) {
	                	categoriaBuilder.numeroApostas(numeroApostas);
	                }
	                if (numeroEventos != null) {
	                	categoriaBuilder.numeroEventos(numeroEventos);
	                }
