package br.com.danielschiavo.infra.evento;
...
import br.com.danielschiavo.dominio.evento.EquipeEvento;
import br.com.danielschiavo.dominio.evento.Evento;
import br.com.danielschiavo.dominio.evento.Evento.EventoBuilder;
import br.com.danielschiavo.dominio.evento.EventoNaoEcontradoException;
import br.com.danielschiavo.dominio.evento.Formato;
import br.com.danielschiavo.dominio.evento.JogadorEvento;
import br.com.danielschiavo.dominio.evento.RepositorioDeEvento;
import br.com.danielschiavo.dominio.evento.StatusEvento;
...
public class RepositorioDeEventoComJdbcPostgres implements RepositorioDeEvento {
	...
	private Evento mapearEventoResultSetParaEvento(UUID id, ResultSet rs) throws SQLException {
		...
		EventoBuilder eventoBuilder = Evento.builder();
